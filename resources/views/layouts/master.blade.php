...
@endsection
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
            <img src="{{ asset('PersianAdminLTE-master/dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
                        ...
                        <div class="card direct-chat direct-chat-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="direct-chat-messages">
                                    ...
                                    <div class="direct-chat-msg">
                                        ...
                                        <!-- /.direct-chat-info -->
                                        <img class="direct-chat-img" src="{{ asset('PersianAdminLTE-master/dist/img/user1-128x128.jpg')}}" alt="message user image">
                                        <!-- /.direct-chat-img -->
                                    ...
                                    <div class="direct-chat-msg right">
                                        ...
                                        <!-- /.direct-chat-info -->
                                        <img class="direct-chat-img" src="{{ asset('PersianAdminLTE-master/dist/img/user3-128x128.jpg')}}" alt="message user image">
                                        <!-- /.direct-chat-img -->
                                        <div class="direct-chat-text">
                                            بهتره اینو باور کنی :)
                                        </div>
                                ...
                                <div class="direct-chat-contacts">
                                    <ul class="contacts-list">
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ asset('PersianAdminLTE-master/dist/img/user1-128x128.jpg')}}">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-left">1397/10/01</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ asset('PersianAdminLTE-master/dist/img/user7-128x128.jpg')}}">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-left">2/23/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ asset('PersianAdminLTE-master/dist/img/user3-128x128.jpg')}}">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-left">2/20/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ asset('PersianAdminLTE-master/dist/img/user5-128x128.jpg')}}">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-left">2/10/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ asset('PersianAdminLTE-master/dist/img/user6-128x128.jpg')}}">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-left">1/27/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ asset('PersianAdminLTE-master/ist/img/user8-128x128.jpg')}}">
